...
`pnpm-lock.yaml`, `yarn.lock`, `bun.lock`, `deno.lock`, `Cargo.lock`, `go.sum`, `uv.lock`, `poetry.lock`, `pdm.lock`, `composer.lock`, `Gemfile.lock`, `packages.lock.json`), records digest,
