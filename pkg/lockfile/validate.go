...
var (
	ecosystems = []string{"npm", "jsr", "url", "cargo", "go", "pypi", "packagist", "rubygems", "nuget"}
	resolvers  = []string{"npm", "pnpm", "yarn", "bun", "deno", "cargo", "go", "uv", "poetry", "pdm", "composer", "bundler", "nuget"}
