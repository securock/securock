...
`source.ecosystems` is an optional, sorted list of detected package
ecosystems. It must not include a path.

## Canonical encoding

- YAML 1.2, 2-space indentation
- artifacts sorted by `ecosystem`, then `name`, then `version`
