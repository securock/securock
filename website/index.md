...
hero:
  ...
  tagline: Reads npm, pnpm, Yarn, Bun, Deno, Cargo, Go, uv, Poetry, PDM, Composer, and Bundler lockfiles, records digest / provenance / signature / vulnerability evidence, and fails when that trust state drifts.
  actions:
    - theme: brand
      text: Read the docs
      link: /guide/install
