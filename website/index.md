...
hero:
  ...
  tagline: Reads npm, pnpm, Yarn, Cargo, Go, and uv lockfiles, records digest / provenance / signature / vulnerability evidence, and fails when that trust state drifts.
  actions:
    - theme: brand
      text: Read the docs
      link: /guide/install
